...
class CreateAppRequest(BaseModel):
    ...
    requesting_user_email_address: EmailStr = Field(description="Email of requesting user")
    sections: List[AppSection] = Field(min_length=1, description="Array of sections with fields")
...
class AddFieldRequest(BaseModel):
    ...
    block_width_percentage_desktop: Optional[Literal[25, 50, 75, 100]] = Field(None, description="Desktop width")
    block_width_percentage_mobile: Optional[Literal[50, 100]] = Field(None, description="Mobile width")
    ...
    allowed_file_types: Optional[List[AllowedFileTypes]] = Field(None, description="Allowed file types, for file fields")
