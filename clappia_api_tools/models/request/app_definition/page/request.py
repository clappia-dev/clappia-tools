...
class PageMetadata(BaseModel, JsonSerializableMixin):
    ...
    previous_button_text: str = Field(default="Previous", description="Previous button text of the page")
...
class AddPageBreakRequest(BaseUpsertPageRequest):
    ...
    page_metadata: PageMetadata = Field(default=PageMetadata(), description="Page metadata")
