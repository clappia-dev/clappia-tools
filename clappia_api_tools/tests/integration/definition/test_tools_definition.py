...
class TestDefinitionToolsIntegration:
    ...
    def test_get_definition_tool_with_language(self, mock_make_request):
        mock_make_request.return_value = (
            ...
            None,
            {
                ...
                "sectionIds": ["section1"],
                "fieldDefinitions": {"field1": {}, "field2": {}},
                "metadata": {"name": "Aplicación de Prueba", "description": "Descripción de prueba"}
            }
        )
    ...
    def test_get_definition_tool_custom_options(self, mock_make_request):
        mock_make_request.return_value = (
            ...
            None,
            {
                ...
                "metadata": {"name": "Test App", "description": "Test with <em>HTML</em>"}
            }
        )
        ...
        sections = [
            {
                ...
                "fields": [
                    {"field_type": "singleLineText", "label": "Full Name", "options": None, "required": False},
                    {"field_type": "singleLineText", "label": "Email Address", "options": None, "required": False}
                ]
            }
        ]
    ...
    @patch('clappia_api_tools.utils.api_utils.ClappiaAPIUtils.make_request')
    @patch('clappia_api_tools.utils.api_utils.ClappiaAPIUtils.validate_environment')
    def test_create_app_tool_multiple_sections(self, mock_validate_env, mock_make_request):
        mock_validate_env.return_value = (True, None)
        mock_make_request.return_value = (
            True,
            None,
        ...
        sections = [
            {
                "section_name": "Personal Information",
                "fields": [
                    {"field_type": "singleLineText", "label": "Full Name", "options": None},
            ...
            },
            {
                ...
                "fields": [
                    {"field_type": "dropDown", "label": "Department", "options": ["Engineering", "Marketing"]},
                    {"field_type": "singleSelector", "label": "Position", "options": ["Junior", "Senior", "Lead"]}
                ]
            },
            {
                "section_name": "Additional Information",
                "fields": [
                    {"field_type": "multiLineText", "label": "Comments", "options": None}
                ]
            }
        ]
    ...
    def test_create_app_tool_validation_error(self):
        sections = [{"section_name": "Test", "fields": [{"field_type": "singleLineText", "label": "Test Field"}]}]
    ...
    def test_create_app_tool_email_validation_error(self):
        sections = [{"section_name": "Test Section", "fields": [{"field_type": "singleLineText", "label": "Test Field"}]}]
    ...
    @patch('clappia_api_tools.utils.api_utils.ClappiaAPIUtils.make_request')
    @patch('clappia_api_tools.utils.api_utils.ClappiaAPIUtils.validate_environment')
    def test_add_field_tool_conditional_field(self, mock_validate_env, mock_make_request):
        mock_validate_env.return_value = (True, None)
        mock_make_request.return_value = (
            True,
            None,
